...
export const generatePokemonCard = async (
  ...
  const pokeType = ((pokemonTypeColor: string) => {
    ...
    <svg width="154" height="65" fill="none">
      <rect width="154" height="64.1667" rx="32.0833" fill="#F6E800"/>
    </svg>
    `
  })
  ...
  const typeText = `
  <svg width="248" height="65">
    <text x="120" y="48" text-anchor="left" font-family="Handjet" font-weight="bold" font-size="25" fill="white">ELECTRIC</text>
  </svg>        
  `
